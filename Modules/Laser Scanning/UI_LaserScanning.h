...
#define  PointTab_DelProtocol             5       /* control type: command, callback function: (none) */
#define  PointTab_AddProtocol             6       /* control type: command, callback function: (none) */
#define  PointTab_Repeat                  7       /* control type: numeric, callback function: (none) */
#define  PointTab_Plate                   8       /* control type: deco, callback function: (none) */
#define  PointTab_Protocol                9       /* control type: ring, callback function: (none) */
#define  PointTab_Mode                    10      /* control type: ring, callback function: (none) */
#define  PointTab_NIntegration            11      /* control type: numeric, callback function: (none) */
#define  PointTab_NPulses                 12      /* control type: numeric, callback function: (none) */
#define  PointTab_PulseOFF                13      /* control type: numeric, callback function: (none) */
#define  PointTab_PulseON                 14      /* control type: numeric, callback function: (none) */
#define  PointTab_HoldBurstPeriodIncr     15      /* control type: numeric, callback function: (none) */
#define  PointTab_HoldBurstPeriod         16      /* control type: numeric, callback function: (none) */
#define  PointTab_RepeatWait              17      /* control type: numeric, callback function: (none) */
#define  PointTab_StartDelayIncrement     18      /* control type: numeric, callback function: (none) */
#define  PointTab_StartDelay              19      /* control type: numeric, callback function: (none) */
#define  PointTab_StimDelay               20      /* control type: numeric, callback function: (none) */
#define  PointTab_Hold                    21      /* control type: numeric, callback function: (none) */
#define  PointTab_DECORATION_2            22      /* control type: deco, callback function: (none) */
#define  PointTab_DECORATION_3            23      /* control type: deco, callback function: (none) */
#define  PointTab_DECORATION              24      /* control type: deco, callback function: (none) */
#define  PointTab_TEXTMSG_2               25      /* control type: textMsg, callback function: (none) */
#define  PointTab_TEXTMSG_3               26      /* control type: textMsg, callback function: (none) */
#define  PointTab_TEXTMSG                 27      /* control type: textMsg, callback function: (none) */
#define  PointTab_Stimulate               28      /* control type: radioButton, callback function: (none) */
#define  PointTab_Record                  29      /* control type: radioButton, callback function: (none) */
