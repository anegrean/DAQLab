...
#define  PointTab_ROIs                    12      /* control type: listBox, callback function: (none) */
#define  PointTab_NRepeat                 13      /* control type: numeric, callback function: (none) */
#define  PointTab_LoadProtocol            14      /* control type: command, callback function: (none) */
#define  PointTab_Plate                   15      /* control type: deco, callback function: (none) */
#define  PointTab_SaveProtocol            16      /* control type: command, callback function: (none) */
#define  PointTab_DelProtocol             17      /* control type: command, callback function: (none) */
#define  PointTab_AddProtocol             18      /* control type: command, callback function: (none) */
#define  PointTab_Protocol                19      /* control type: ring, callback function: (none) */
#define  PointTab_NIntegration            20      /* control type: numeric, callback function: (none) */
#define  PointTab_NPulses                 21      /* control type: numeric, callback function: (none) */
#define  PointTab_PulseOFF                22      /* control type: numeric, callback function: (none) */
#define  PointTab_PulseON                 23      /* control type: numeric, callback function: (none) */
#define  PointTab_StimDelay               24      /* control type: numeric, callback function: (none) */
#define  PointTab_DECORATION_2            25      /* control type: deco, callback function: (none) */
#define  PointTab_DECORATION_3            26      /* control type: deco, callback function: (none) */
#define  PointTab_DECORATION              27      /* control type: deco, callback function: (none) */
#define  PointTab_TEXTMSG_2               28      /* control type: textMsg, callback function: (none) */
#define  PointTab_TEXTMSG_3               29      /* control type: textMsg, callback function: (none) */
#define  PointTab_TEXTMSG                 30      /* control type: textMsg, callback function: (none) */
