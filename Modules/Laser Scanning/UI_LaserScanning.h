...
#define  ScanPan_EngineTab                3       /* control type: tab, callback function: (none) */
...
#define  ScanSetPan_Calibrate             4       /* control type: command, callback function: (none) */
#define  ScanSetPan_Plate                 5       /* control type: deco, callback function: (none) */
#define  ScanSetPan_XCommand              6       /* control type: string, callback function: (none) */
#define  ScanSetPan_YCommand              7       /* control type: string, callback function: (none) */
#define  ScanSetPan_ImageOut              8       /* control type: string, callback function: (none) */
#define  ScanSetPan_ImgChans              9       /* control type: listBox, callback function: (none) */
