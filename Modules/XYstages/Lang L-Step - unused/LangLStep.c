...
static int			InitStageConnection						(char** errorMsg);

	// closes an open connection to the Lang LStep stage controller
static int			CloseStageConnection					(char** errorMsg);
...
Error:
	...
	if (errorMsg)
		*errorMsg = FormatMsg(error, "InitStageConnection", errMsg);
	OKfree(errMsg);
...
Error:
	...
	if (errorMsg)
		*errorMsg = FormatMsg(error, "CloseStageConnection", errMsg);
	OKfree(errMsg);
...
Error:
	...
	if (errorMsg)
		*errorMsg = FormatMsg(error, "MoveStage", errMsg);
	OKfree(errMsg);
...
Error:
	...
	if (errorMsg)
		*errorMsg = FormatMsg(error, "SetStageLimits", errMsg);
	OKfree(errMsg);
...
Error:
	...
	if (errorMsg)
		*errorMsg = FormatMsg(error, "GetStageLimits", errMsg);
	OKfree(errMsg);
...
Error:
	...
	if (errorMsg)
		*errorMsg = FormatMsg(error, "SetStageVelocity", errMsg);
	OKfree(errMsg);
...
Error:
	...
	if (errorMsg)
		*errorMsg = FormatMsg(error, "GetStageVelocity", errMsg);
	OKfree(errMsg);
...
Error:
	...
	if (errorMsg)
		*errorMsg = FormatMsg(error, "GetStageAbsPosition", errMsg);
	OKfree(errMsg);
