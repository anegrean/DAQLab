...
@"c:\program files (x86)\national instruments\cvi2013\bin\clang\2.9\clang.exe" -cc1 -nostdinc -emit-obj -add-plugin cvi-emit-defprots -plugin-arg-cvi-emit-defprots %DefProts%  -disable-current-directory -I ".\UnsavedChanges" -I %OrigSrcDir% %REST% -std=c99     -main-file-name %OrigSrcName%  @"CC_options.txt" -D_CVI_="1300"  -D_NI_x64_="1"  -D_NI_mswin_="1"  -D_NI_mswin64_="1"  -D_CVI_DEBUG_="1"  -D_CVI_EXE_="1"  -D_LINK_CVIRTE_="1"  -D_CVI_FDS_="1"  -D_CVI_USE_FUNCS_FOR_VARS_="1"  -D__DEFALIGN="8"  -D_NI_VC_="220"  -D_WIN32="1"  -D_WIN64="1"  -DWIN32="1"  -DWIN64="1"  -D__WIN32__="1"  -D__WIN64__="1"  -D_WINDOWS="1"  -D__NT__="1"  -D_M_X64="1"  -D_M_AMD64="1"  -D__FLAT__="1"  -D_PUSHPOP_SUPPORTED="1"  -D_CVI_C99_EXTENSIONS_="1"  -D_CVI_PROFILE_LEVEL_="0"  -D_TARGET_FILE_VERSION_="\"1.0.0.0\""  -D_TARGET_PRODUCT_VERSION_="\"1.0.0.0\""  -D_OPENMP="200505"  -D_CVI_CONFIGURATION_NAME_="\"Debug64\""  -D_CVI_RTE_SHARED_="1"  -DWIN32_LEAN_AND_MEAN  -o %ObjFileName%  %SrcFileName%  > %OutFileName% 2>&1
